...
export default function ProcessCard({ text }: Props) {
  return (
    <div className="flex w-full max-w-[1234px] items-center justify-between gap-[10px] whitespace-nowrap rounded-[45px] border border-[#191A23] bg-[#F3F3F3] px-[60px] py-[41px] shadow-[0_5px_0_0_#191A23]">
